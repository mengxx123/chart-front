                ...
                <div class="tab-content">
                    <div id="tab11" class="tab-pane fade active in">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">显示标签</label>
                                <div class="col-sm-9">
                                    <label class="checkbox-inline ">
                                        <input type="checkbox" v-model="option.series.showLabel">显示
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
        ...
        methods: {
            ...
            show_chart: function (type, title, ytitle, datagrid) {
                ...
                var option = {
                    ...
                    tooltip: {},
                    legend: {
                        show: this.option.legend.show,
                        orient: 'vertical',
                        left: this.option.legend.left,
                        top: this.option.legend.top,
                        //right: 'right',
